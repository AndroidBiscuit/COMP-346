...
// Adding the Thread heritage extension
public class Client extends Thread {
    ...
    public void run()
    {
        ...
        // Implement the thread required for sending
        if (getClientOperation().equals("sending")) {
            // Send the start time of the transactions (sending)
            sendClientStartTime = System.currentTimeMillis();
            sendTransactions();

            // Send the end time of the transactions (sending)
            sendClientEndTime = System.currentTimeMillis();

            // Print termination message
            System.out.println("\n" + "Terminating client sending thread -  Running time " + (sendClientEndTime - sendClientStartTime) + " ms");
        }
        // Implement the thread required for receiving
        else if (getClientOperation().equals("receiving")) {
            // Send the start time of the transactions (receiving)
