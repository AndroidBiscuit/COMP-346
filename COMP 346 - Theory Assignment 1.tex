...
\begin{table}[h]
    ...
    \begin{tabularx}{0.4\textwidth} { 
      ...
      | >{\centering\arraybackslash}X | }
     \hline
     \textbf{Process} & \textbf{CPU} & \textbf{I/O} & \textbf{CPU} \\
     \hline
     \textbf{P1} & 15 & 10 & 10 \\
     \hline
     \textbf{P2} & 10 & 5 & 15 \\
...
\begin{enumerate}[label=\alph*)]
  ...
  \begin{itemize}[label={}]
  \item Since the throughput is the number of tasks performed per unit of time, we can simply divide 2 (the total amount of tasks) by the minimal total time required to complete the executions, hence:
  \item Single-programmed: \[ 2/65 = 0.031 \]
  \item Multi-programmed: \[ 2/50 = 0.040 \]
  \item We can see that the multi-programmed operating system has a higher throughput (because it doesn't wait for the I/O) and so its more efficient. 
  \end{itemize}
\end{enumerate}
